/* =========================================
   ==========  MACHINE 10 — PRONE LEG CURL
   ========================================= */

export function Machine10() {
  ...
  title.textContent = "#10 PRONE LEG CURL";
  ...
  tempoLabel.id = "tempo-label-10";
  tempoLabel.textContent = "Tempo ▸";

  const tempoValue = document.createElement("span");
  tempoValue.id = "tempo-value-10";
  ...
  timerDisplay.id = "timer-display-10";
