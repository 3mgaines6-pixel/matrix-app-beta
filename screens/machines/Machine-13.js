/* =========================================
   ==========  MACHINE 13 — HIP ADDUCTOR
   ========================================= */

export function Machine13() {
  ...
  title.textContent = "#13 HIP ADDUCTOR";

  const subtitle = document.createElement("div");
  subtitle.className = "machine-subtitle";
  subtitle.textContent = "Inner Thighs • LIGHT • 3×12–15";
  ...
  tempoLabel.id = "tempo-label-13";
  tempoLabel.textContent = "Tempo ▸";

  const tempoValue = document.createElement("span");
  tempoValue.id = "tempo-value-13";
  ...
  timerDisplay.id = "timer-display-13";
