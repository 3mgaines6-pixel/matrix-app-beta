/* =========================================
   ==========  MACHINE 2 — TRICEPS PRESS
   ========================================= */

export function Machine2() {
  ...
  title.textContent = "#2 TRICEPS PRESS";

  const subtitle = document.createElement("div");
  subtitle.className = "machine-subtitle";
  subtitle.textContent = "Triceps • MODERATE • 3×10–12";
  ...
  tempoLabel.id = "tempo-label-2";
  tempoLabel.textContent = "Tempo ▸";

  const tempoValue = document.createElement("span");
  tempoValue.id = "tempo-value-2";
  ...
  timerDisplay.id = "timer-display-2";
