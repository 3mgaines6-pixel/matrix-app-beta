/* =========================================
   ==========  MACHINE 11 — LEG EXTENSION
   ========================================= */

export function Machine11() {
  ...
  title.textContent = "#11 LEG EXTENSION";

  const subtitle = document.createElement("div");
  subtitle.className = "machine-subtitle";
  subtitle.textContent = "Quads • LIGHT • 3×10–12";
  ...
  tempoLabel.id = "tempo-label-11";
  tempoLabel.textContent = "Tempo ▸";

  const tempoValue = document.createElement("span");
  tempoValue.id = "tempo-value-11";
  ...
  timerDisplay.id = "timer-display-11";
