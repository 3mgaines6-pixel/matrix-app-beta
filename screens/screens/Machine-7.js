/* =========================================
   ==========  MACHINE 7 — CHEST PRESS
   ========================================= */

export function Machine7() {
  ...
  title.textContent = "#7 CHEST PRESS";

  const subtitle = document.createElement("div");
  subtitle.className = "machine-subtitle";
  subtitle.textContent = "Chest • HEAVY • 3×8–10";
  ...
  tempoLabel.id = "tempo-label-7";
  tempoLabel.textContent = "Tempo ▸";

  const tempoValue = document.createElement("span");
  tempoValue.id = "tempo-value-7";
  ...
  timerDisplay.id = "timer-display-7";
